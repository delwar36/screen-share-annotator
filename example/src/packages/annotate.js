...
async function sendEmail(storage, template_id, api_key) {
...
export default async function annotate(app_instance, template_id, api_key) {
  ...
  sendEmailButton.onclick = async () => {
    sendEmail(storage, template_id, api_key);
  };
